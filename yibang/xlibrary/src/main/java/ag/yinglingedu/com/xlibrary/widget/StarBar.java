...
import ag.yinglingedu.com.xlibrary.R;
...
public class StarBar extends View {
    ...
    public boolean isCanChangeable() {
        return canChangeable;
    }

    public void setCanChangeable(boolean canChangeable) {
        this.canChangeable = canChangeable;
    }

    private boolean canChangeable = true;
