...
import ag.yinglingedu.com.ag.model.publish.ActivityPublish_FXQ;
...
public class FragmentAllKinds extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_all_kinds, null, false);
    ...
    public void init() {
        ...
        lvShow.setAdapter(new CommonAdapter<BeanFXQ>(getContext(),mList,R.layout.item_all_kinds) {
            @Override
